...
title: Idempotency
description:
  What is idempotency and how it works with Zūm APIs.
---

# Idempotency

Idempotency means that successfully processed requests are not reprocessed. The response for the completed processing is reported instead.
